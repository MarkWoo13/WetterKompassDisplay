...
#include "board/supported/waveshare/BOARD_WAVESHARE_ESP32_S3_TOUCH_LCD_2_8_C.h"
#include "board_external_config.hpp"

// The stock Waveshare 2.8C config uses 18 MHz, which refreshes this 480x480 RGB panel
// at about 64 FPS. Lowering PCLK reduces continuous PSRAM/LCD bandwidth pressure while
// keeping the UI responsive for a mostly static weather display.
